...
<ol class="breadcrumb">
    ...
    <li><a href="{{ route('backend.school-year.registrars.index', array(SchoolYear::getActivated()->id)) }}">Registrars</a></li>
    ...
    <div class="col-md-8">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Update Registrar</h3>
            ...
            <div class="box-body">
                {{ 
                    Form::open(
                        array(
                            'route'=>array(
                                'backend.school-year.registrars.update',
                            ...
                            <label style="margin-right:20px">
                                {{ 
                                    Form::radio(
                                        'gender',
                                        'male',
                                        $registrar->user->gender=='male' ? true:null,
                                        array(
                                            'class'=>'minimal-red',
                                        )
                                    ) 
                            ...
                            <label>
                                {{ 
                                    Form::radio(
                                        'gender',
                                        'female',
                                        $registrar->user->gender=='female' ? true:null,
                                        array(
                                            'class'=>'minimal-red',
                                        )
                                    ) 
