...
<ol class="breadcrumb">
    ...
    <li><a href="{{ route('backend.school-year.guards.index', array(SchoolYear::getActivated()->id)) }}">Guards</a></li>
    ...
    <div class="col-md-8">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Update Guard</h3>
            ...
            <div class="box-body">
                {{ 
                    Form::open(
                        array(
                            'route'=>array(
                                'backend.school-year.guards.update',
                            ...
                            <label style="margin-right:20px">
                                {{ 
                                    Form::radio(
                                        'gender',
                                        'male',
                                        $guard->user->gender=='male' ? true:null,
                                        array(
                                            'class'=>'minimal-red',
                                        )
                                    ) 
                            ...
                            <label>
                                {{ 
                                    Form::radio(
                                        'gender',
                                        'female',
                                        $guard->user->gender=='female' ? true:null,
                                        array(
                                            'class'=>'minimal-red',
                                        )
                                    ) 
