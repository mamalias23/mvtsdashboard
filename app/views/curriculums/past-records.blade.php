...
<h1>
    Curriculums in {{ SchoolYear::find(Input::get('school_year'))->school_year }}
                ...
                <table class="table table-striped">
                    <tbody>
                        ...
                        @else
                           <tr>
                                <td colspan="3">
                                    No curriculums added for school year {{ SchoolYear::find(Input::get('school_year'))->school_year }}
                                </td>
                            </tr> 
                        @endif
                    </tbody>
