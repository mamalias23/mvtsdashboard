...
<ol class="breadcrumb">
    ...
    <li><a href="{{ route('backend.school-year.staffs.index', array(SchoolYear::getActivated()->id)) }}">Staffs</a></li>
            ...
            <div class="box-body">
                {{ 
                    Form::open(
                        array(
                            'route'=>array(
                                'backend.school-year.staffs.update',
                            ...
                            <label style="margin-right:20px">
                                {{ 
                                    Form::radio(
                                        'gender',
                                        'male',
                                        $staff->user->gender=='male' ? true:null,
                                        array(
                                            'class'=>'minimal-red',
                                        )
                                    ) 
                            ...
                            <label>
                                {{ 
                                    Form::radio(
                                        'gender',
                                        'female',
                                        $staff->user->gender=='female' ? true:null,
                                        array(
                                            'class'=>'minimal-red',
                                        )
                                    ) 
