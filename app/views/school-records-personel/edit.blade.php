...
<h1>
    Update School Records Personel
    <small></small>
</h1>
<ol class="breadcrumb">
    ...
    <div class="col-md-8">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Update School Records Personel</h3>
                            ...
                            <label style="margin-right:20px">
                                {{ 
                                    Form::radio(
                                        'gender',
                                        'male',
                                        $personel->user->gender=='male' ? true:null,
                                        array(
                                            'class'=>'minimal-red',
                                        )
                                    ) 
                            ...
                            <label>
                                {{ 
                                    Form::radio(
                                        'gender',
                                        'female',
                                        $personel->user->gender=='female' ? true:null,
                                        array(
                                            'class'=>'minimal-red',
                                        )
                                    ) 
